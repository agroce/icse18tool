...
\% tstl avlnew.tstl
\% mutate avl.py
\% analyze\_mutants avl.py ``tstl\_rt --timeout 10''
\end{code}

This process will produce a pair of files, {\tt notkilled.txt} and {\tt
  killed.txt} containing names of mutants for which the command
returned an error code of zero or non-zero, respectively.